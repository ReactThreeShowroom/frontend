...
// export const BASE_URL = 'https://api-1i72.onrender.com' //live site
// export const BASE_URL = 'https://api-3frl.onrender.com' //dev site
export const BASE_URL = 'http://localhost:3000' // for local dev
